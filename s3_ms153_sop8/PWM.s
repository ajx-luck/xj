...
.stabs "C:\mcuproject\xj\s3_ms153_sop8\PWM.c",100,0,3,0
...
.stabn 68,0,43,L20
L20:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(43):"
wdtc
.stabn 68,0,43,L21
L21:
.stabn 68,0,44,L22
L22:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(44):"
disi
.stabn 68,0,44,L23
L23:
.stabn 68,0,45,L24
...
.stabn 68,0,53,L29
L29:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(53):"
eni
.stabn 68,0,53,L30
L30:
.stabn 68,0,55,L31
...
.stabn 68,0,59,L34
L34:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(59):"
wdtc
.stabn 68,0,59,L35
L35:
.stabn 68,0,60,L36
...
.stabn 68,0,170,L167
L167:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(170):"
mov	a,@0x02
.stabn 68,0,171,L168
L168:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(171):"
contw
.stabn 68,0,173,L169
L169:
.stabn 224,0,0,L170
...
.stabn 68,0,244,L271
L271:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(244):"
disi
.stabn 68,0,244,L272
L272:
.stabn 68,0,245,L273
L273:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(245):"
slep
.stabn 68,0,245,L274
L274:
.stabn 68,0,246,L275
L275:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(246):"
eni
.stabn 68,0,246,L276
L276:
.stabn 68,0,247,L277
...
.stabn 68,0,259,L290
L290:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(259):"
MOV 0x3D,A ;保存 A
.stabn 68,0,260,L291
L291:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(260):"
MOV A,0x03
.stabn 68,0,261,L292
L292:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(261):"
MOV 0x3E,A ;保存 R3
.stabn 68,0,262,L293
L293:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(262):"
MOV A,0x04
.stabn 68,0,263,L294
L294:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(263):"
MOV 0x3F,A ;保存 R4
.stabn 68,0,266,L295
L295:
jbs _TCIF,0
...
.stabn 68,0,283,L309
L309:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(283):"
MOV A,0x3F ;返回 R4
.stabn 68,0,284,L310
L310:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(284):"
MOV 0x04,A
.stabn 68,0,285,L311
L311:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(285):"
MOV A,0x3E ;返回 R3
.stabn 68,0,286,L312
L312:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(286):"
MOV 0x03,A
.stabn 68,0,287,L313
L313:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(287):"
SWAP 0x3D  ;返回 A
.stabn 68,0,288,L314
L314:
.cfile "C:\mcuproject\xj\s3_ms153_sop8\PWM.c(288):"
SWAPA 0x3D
.stabn 68,0,290,L315
L315:
.stabn 224,0,0,L316
